/**
 * navbar.js
 * Barra superior: toggle de sidebar (móvil), buscador rápido y menú de usuario.
 */
  ...
  return `
    <header class="sw-topbar">
      <div class="d-flex align-items-center gap-3">
        <button class="btn btn-light sw-sidebar-toggle" id="sw-sidebar-toggle" aria-label="Abrir menú">
      ...
      <div class="d-flex align-items-center gap-3">
        <div class="dropdown">
          <button class="btn d-flex align-items-center gap-2 border-0" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <span class="d-none d-md-inline fw-semibold">${user?.name || 'Usuario'}</span>
          ...
          <ul class="dropdown-menu dropdown-menu-end shadow-sm">
            ...
            <li><button class="dropdown-item text-danger" id="sw-logout-btn"><i class="bi bi-box-arrow-right me-2"></i>Cerrar sesión</button></li>
          </ul>
        </div>
      </div>
    </header>`;
